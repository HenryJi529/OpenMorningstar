...
JAZZMIN_UI_TWEAKS = {"sidebar_nav_child_indent": True, "sidebar_fixed": True}
...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        {
            "name": "支持",
            "url": "https://github.com/HenryJi529/OpenMorningstar/issues",
            "new_window": True,
        },
        {"name": "休闲", "url": "https://web.sanguosha.com/", "new_window": True},
    ...
    "icons": {
        ...
        "Morningstar": "fas fa-atom",
        "Morningstar.user": "far fa-id-card",
        "Morningstar.visiablesetting": "fas fa-eye",
        "blog": "fab fa-blogger-b",
        "blog.category": "far fa-map",
        "blog.post": "far fa-file-word",
        "blog.tag": "fas fa-tag",
        "blog.comment": "far fa-comment-dots",
        "book": "fas fa-atlas",
        "book.book": "fas fa-book",
        "book.category": "fas fa-box",
        "book.author": "fas fa-copyright",
        "book.translator": "fas fa-language",
        "joke": "far fa-images",
